...
const ContactUs = () => {
  ...
  <div className="hero-content flex-col lg:flex-row">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" className="m-4" width="40" height="40" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
