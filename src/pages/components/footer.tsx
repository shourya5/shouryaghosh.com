export default function Footer() {
  ...
  <div className="items-center grid-flow-col">
    ...
    <p>Email: <a className="link link-hover fill-white" href="mailto:shourya5@illinois.edu">shourya5@illinois.edu</a></p>
  </div> 
  <div className="grid-flow-col gap-9 md:place-self-center md:justify-self-end">
    <a href = "https://www.linkedin.com/in/shourya-ghosh/"><svg className = 'fill-white' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor"width="35" height="35" focusable="false">
